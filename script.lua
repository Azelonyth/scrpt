--[[
    SAMBUNG KATA AUTO - V17.3 DENGAN DETEKSI LEBIH PINTAR
    - Scan otomatis lebih selektif, hanya ambil teks dengan titik dua atau 1-2 huruf.
    - Blacklist diperluas (termasuk PURCHASED, BUY, dll).
    - Setelah scan, langsung gunakan target tanpa setup ulang.
]]
...
local Config = {
    ...
    SavedCFrame = nil,
    TargetUIName = "",
    Blacklist = {"ZAT", "SKOR", "SCORE", "MENU", "WAKTU", "TIME", "LEVEL", "RANK", "RECORD", "TEAM", "REWARDS", "PLAYERS", "ROUND", "SETTINGS", "BACK", "CLOSE", "EXIT", "BUY", "SELL", "PURCHASED", "PURCHASE", "BUY NOW", "CONFIRM", "CANCEL"},
    ShowLogs = true
}
...
local Window = Rayfield:CreateWindow({
    Name = "Sambung Kata | ULTIMATE V17.3",
    LoadingTitle = "Deteksi Lebih Pintar",
            ...
            if gui:IsA("ScreenGui") and gui.Enabled then
                for _, obj in ipairs(gui:GetDescendants()) do
                    if (obj:IsA("TextLabel") or obj:IsA("TextButton")) and obj.Visible and obj.Text ~= "" then
                        ...
                        -- Kriteria: mengandung titik dua ATAU (panjang 1-2 huruf dan hanya huruf)
                        if t:find(":") or (t:match("^%a%a?$") and #t <= 2) then
                            Config.TargetUIName = obj.Name
                            Rayfield:Notify({Title="Target ditemukan!", Content=obj.Name .. " : " .. t})
                            log("Target otomatis: " .. obj.Name .. " dengan teks: " .. t)
                            return
                        end
                    end
                end
